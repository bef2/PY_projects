...
#------------------------------------------------------------------------------------------
        # Рамка выбора порта
        self. var['frame_choice_port_' + axis] = QFrame(self.var['frame_axis_' + axis])
        ...
        # Сетка рамки выбора порта
        self.var['layout_choice_port_' + axis] = QHBoxLayout(self. var['frame_choice_port_' + axis])
...
#------------------------------------------------------------------------------------------
        ...
        self.var['layout_axis_' + axis].addWidget(self. var['frame_choice_port_' + axis])
