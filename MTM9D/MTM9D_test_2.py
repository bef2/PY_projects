...
class serial_485_stream(QThread):
    ...
    ser.timeout = 0.5   # Время ожидания данных чтения
    ...
    def run(self):
        ...
        while self.flag_state:
            ...
            try:
                ...
                time.sleep(1)
                try:
                    self.ser.port = self.mainwindow.combobox_setCOM.currentText()
                    self.ser.open()
                    if self.ser.isOpen():
...
class myWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.label_creator.setAlignment(QtCore.Qt.AlignCenter|QtCore.Qt.AlignBottom)
    ...
    def openCOM(self):
        ...
        serial_485_stream.flag_state = False
        serial_485_stream.ser.port = self.combobox_setCOM.currentText()
        try:
